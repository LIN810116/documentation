...
project = 'abi-ctt-documentation'
copyright = '2022, Chinchien Lin, Thiranja Prasad Babarenda Gamage'
...
html_logo = '_static/images/abi-vc-rgb.png'
html_favicon = '_static/images/abi-logo.png'
